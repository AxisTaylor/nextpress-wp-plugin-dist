<?php
/**
 * Setting registry. Manages NextPress Settings API.
 *
...
class Settings_Registry {
	...
	public function register_field( string $section, array $field ) {
		 ...
		 */
		$field = apply_filters( 'nextpress_setting_field_config', $field_config, $field_name, $section );
	...
	public function admin_init() {
		...
		do_action( 'nextpress_init_settings', $this );
		 ...
		 */
		$setting_sections = apply_filters( 'nextpress_settings_sections', $this->settings_sections );
			...
			<?php foreach ( $this->settings_sections as $id => $form ) { ?>
				<div id="<?php echo esc_attr( $id ); ?>" class="group" style="display: none;">
					<form method="post" action="options.php">
						<?php
						do_action( 'nextpress_settings_form_top', $form );
						settings_fields( $id );
						do_settings_sections( $id );
						do_action( 'nextpress_settings_form_bottom', $form );
